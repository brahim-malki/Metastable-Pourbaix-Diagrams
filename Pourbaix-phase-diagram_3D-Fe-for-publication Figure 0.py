...
# with fixed concentration
pbx = PourbaixDiagram(entries, comp_dict={"Fe": 1.0 }, conc_dict={"Fe": concentration})
...
def create_figure():
    ...
    ax.set_xticklabels(ax.get_xticks(), fontname=font, fontsize=20)
    ax.set_ylim(-1.1, 1.1)
    ax.set_yticks([-1, 0, 1])
    ax.set_yticklabels(ax.get_yticks(), fontname=font, fontsize=20)
    ax.set_zlim(-15, 2)
    ax.set_zticks([-15, -10, -5, 0, 2])
    ax.set_zticklabels(ax.get_zticks(), fontname=font, fontsize=20)
#    ax.set_xlabel("pH", fontname=font, fontsize=20)
#    ax.set_ylabel("Potential vs. SHE (V)", fontname=font, fontsize=20)
 #   ax.set_zlabel("Pourbaix Potential (eV/Mn)", fontname=font, fontsize=20)
...
stable_domain_   = pbx.get_pourbaix_domains(unstable_entries, limits)
list_domains_ = list(stable_domain_[1].keys())
vertices_list_=list(stable_domain_[1].values())
